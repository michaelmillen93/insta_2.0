...
const Modal = () => {
  ...
  //Allows user to open file picker and select file as an object
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          {/* Tricks browser into centering modal contents */}
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pl-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                  ...
                  >
                    <CameraIcon
                      className="h-6 w-6 text-red-600 aria-hidden="
                      true
                    />
                  </div>
                )}
